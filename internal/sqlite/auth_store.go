...
func (s *AuthStore) Register(ctx context.Context, user portyauth.User, session portyauth.SessionRecord) error {
...
func (s *AuthStore) CreateSession(ctx context.Context, session portyauth.SessionRecord) error {
...
func insertSession(ctx context.Context, target execer, session portyauth.SessionRecord) error {
...
func (s *AuthStore) SessionByTokenHash(ctx context.Context, hash []byte) (portyauth.SessionRecord, error) {
	var record portyauth.SessionRecord
	...
	if err != nil {
		return portyauth.SessionRecord{}, err
	}
